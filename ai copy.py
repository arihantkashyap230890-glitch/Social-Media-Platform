...
NEGATIVE_WORDS = {
    ...
    "issue", "problem", "sad", "stress", "stuck", "terrible", "tired", "worried", "nigga", 
}
STOP_WORDS = {
...
CATEGORY_HINTS = {
    ...
    "fun": {"fun", "game", "joke", "meme", "random", "silly", "smile", "surprise"},
    "career": {"advice", "career", "growth", "job", "learn", "mentor", "network", "opportunity"},
    "hobbies" : {"music", "sports", "dance", "art", "craft", "cook", "diy", "hobby", "photo", "writing"},
}
